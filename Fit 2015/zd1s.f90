! =================================================
!  parametrization for chiral-even DiFF D1s(z,Mh;Q0) with Q0 = 1 GeV
!  from  Phys. Rev. D85 (2012) 114023, arXiv:1202.0323 [hep-ph]
!  input z , parameter Mh 
!  output  z D1s(z,Mh;Q0)
! =================================================

double precision function zd1s(z,m)
...
!  parameters for background channel
   ...
   &                              N_BG2=0.78251d0, A_BG3=0.63652d0
...
!  parameters for rho resonant channel
   ...
   &                              N_RH2=0.86127d0, A_RH3=-0.24381d0
...
!  parameters for the omega channel
   ...
   &                              N_OM2=0.29657d0, A_OM2=-1.2326d0
...
!  parameters for the kaon resonant channel
   ...
   &                              N_KA3=2.5507d0, A_KA2=0.76635d0
   ...
   &         dexp(G_KA1/z+G_KA2+G_KA3*z+G_KA4*z**2) * dsqrt(m**2-4.d0*mpi**2)
	...
	zd1s = z * (  N_BG2**2 * (1.d0-z)**(A_BG3**2) * bkg +      &
   &              N_RH2**2 * z**A_RH3 * (1.d0-z) * rho +       &
   &			  N_OM2**2 * z**A_OM2 * omega +                &
   &			  N_KA3**2 * z**A_KA2 * kaon   )
